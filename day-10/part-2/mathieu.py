        ...
        while round_nb < rounds:
            for length in lengths:
                if current_pos + length < n:
                    sublist = list(reversed(numbers[current_pos:current_pos + length]))
                    numbers = numbers[:current_pos] + sublist + numbers[current_pos + length:]
                else:
                    sublist = list(reversed(numbers[current_pos:] + numbers[:current_pos + length - n]))
                    new_numbers = sublist[n - current_pos:]
